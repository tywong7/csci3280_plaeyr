...
public:
    ...
    QLabel *label;
    QLineEdit *song_input;
    QHBoxLayout *horizontalLayout_2;
    QLabel *label_2;
    QLineEdit *singer_input;
    QHBoxLayout *horizontalLayout_3;
    QLabel *label_3;
    QLineEdit *abum_input;
    ...
    void setupUi(QDialog *Edit_Form)
    {
        ...
        song_input = new QLineEdit(bar3);
        song_input->setObjectName(QString::fromUtf8("song_input"));
        song_input->setFont(font);

        horizontalLayout->addWidget(song_input);
        ...
        singer_input = new QLineEdit(bar3);
        singer_input->setObjectName(QString::fromUtf8("singer_input"));
        singer_input->setFont(font);

        horizontalLayout_2->addWidget(singer_input);
        ...
        abum_input = new QLineEdit(bar3);
        abum_input->setObjectName(QString::fromUtf8("abum_input"));
        abum_input->setFont(font);

        horizontalLayout_3->addWidget(abum_input);
...
""));
    ...
    void retranslateUi(QDialog *Edit_Form)
    {
        ...
        label->setText(QApplication::translate("Edit_Form", "Song", nullptr));
        label_2->setText(QApplication::translate("Edit_Form", "Singer", nullptr));
        label_3->setText(QApplication::translate("Edit_Form", "Album", nullptr));
    } // retranslateUi
